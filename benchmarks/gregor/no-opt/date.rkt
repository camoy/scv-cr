(module date typed/racket/base/no-check
   (#%module-begin
    ...
    (module require/contracts racket/base
      ...
      (provide g54 g55 g56 g57 g58 l/1 (contract-out (~r l/1))))
    ...
    (define (date<=? d1 d2) (<= (date->jdn d1) (date->jdn d2)))
    (provide)
    (provide (contract-out (date<=? generated-contract50))
             (contract-out (date=? generated-contract51))
             (contract-out (date->iso8601 generated-contract47))
             (contract-out (date->iso-wyear generated-contract46))
             (contract-out (date->iso-week generated-contract45))
             (contract-out (jdn->date generated-contract52))
             (contract-out (ymd->date generated-contract53))
             (contract-out (date->jdn generated-contract48))
             (contract-out (date->ymd generated-contract49))
             (contract-out (date generated-contract44)))))
