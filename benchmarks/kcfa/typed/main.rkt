...
(define mid-test
   (make-call
    (make-lambda
     '($f96)
     (make-call
      (make-lambda '($e97) (make-call (make-ref '$f96) (make-ref '$e97)))
      (make-lambda
       '(p1 $k98)
       (make-call
        (make-ref '$k98)
     ...
     (make-call
      (make-lambda
       ...
       (make-call
        (make-lambda
         '($e112)
         (make-call (make-ref '$f111) (make-ref '$e112) (make-ref '$k110)))
        (make-lambda
         '(m1 $k113)
         (make-call
          (make-ref '$k113)
       ...
       (make-call
        (make-lambda
         ...
         (make-call
          (make-lambda
           '($e122)
           (make-call (make-ref '$f121) (make-ref '$e122) (make-ref '$k120)))
          (make-lambda
           '(n $k123)
           (make-call
            (make-ref '$k123)
                       ...
                       (make-call
                        ...
                        (make-lambda
                         ...
                         (make-call
                          ...
                          (make-lambda
                           '(id $k128)
                           (make-call (make-ref '$k128) (make-ref 'id)))))))
                      (make-lambda
                       '(ignored $k131)
                       (make-call (make-ref '$k131) (make-ref 'rx)))))))
                  (make-lambda
                   '(g $k134)
                   (make-call
                    (make-ref '$k134)
         ...
         (make-call
          (make-lambda
           ...
           (make-call
            (make-lambda
             '($e142)
             (make-call (make-ref '$f141) (make-ref '$e142) (make-ref '$k140)))
            (make-lambda
             '(s1 $k143)
             (make-call
              (make-ref '$k143)
             ...
             (make-call
              ...
              (make-lambda
               ...
               (make-call
                ...
                (make-lambda
                 '(x0 $k153)
                 (make-call (make-ref '$k153) (make-ref 'x0)))))))
            (make-lambda
             '(church0 $k154)
             (make-call
              (make-lambda
...
(define (main N e) (for ((a-k (in-range N))) (analyze e)))
